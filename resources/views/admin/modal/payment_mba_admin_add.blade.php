...
<body>
    ...
    <div class="container mt-5">
        ...
        <form  action="/ajukan" method="post" enctype="multipart/form-data">
            ...
            <!-- Skema Fee -->
            <div class="mb-3">
                <label class="form-label">Total_Fee <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="fees" placeholder="Jawaban Anda" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Fee MBA <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="Fee_mba" placeholder="Masukkan Fee MBA" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Fee Mitra <span class="text-danger">*</span></label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (tambahBarangModal) {
                tambahBarangModal.addEventListener('show.bs.modal', function() {
                    fetch('/generate-Kode-pengajuan')
                        .then(response => response.json())
                        .then(data => {
                            document.getElementById('Kode_pengajuan').value = data.kode_barang;
                        })
            ...
            form.addEventListener('submit', function(event) {
                ...
                if (checkboxes.length === 0) {
                    alert('Silakan pilih minimal satu jenis pajak.');
