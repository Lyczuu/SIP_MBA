    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" action="/sok" method="post" enctype="multipart/form-data">
                ...
                <label class="cutof-setlement-formlabel"><strong>Wag kordinasi Rekon & Payment<span
                            class="text-danger">*</span></strong></label>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="wag_kordinasi_rekon"
                        placeholder="Masukan WAG Koordinasi Rekon" required value="{{ old('wag_kordinasi_rekon') }}">
                </div>
                <!-- Submit -->
