...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Form Integrasi Payment MBA No Fee Base(admin)</h5>
            <form class="row g-3" action="/sok" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <!-- Cutoff -->
                <label class="cutof-setlement-formlabel"><strong> Cuttoff & Settlement<span class="text-danger">*</span></strong></label>
                <div class="col-4">
                    <label class="form-label">Cutoff </label>
                    <input type="text" class="form-control" name="cutoff" placeholder="Masukan Cutoff" required>
                </div>
                ...
                <!-- PIC Payment Mitra -->
                <label class="pic-telepon-formlabel"><strong>Pic & Telepon<span class="text-danger">*</span></strong></label>
                <div class="col-4">
                ...
                <label class="cutof-setlement-formlabel"><strong>Wag kordinasi Rekon & Payment<span class="text-danger">*</span></strong></label>
                <div class="col-6">
