                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="borderedTabJustified" role="tablist">
                                    <li class="nav-item flex-fill" role="presentation">
                                        <a class="nav-link w-50 {{ Request::routeIs('nofeea.belumvalidasi') ? 'active' : '' }}"
                                            id="diajukan-tab" href="{{ route('nofeea.belumvalidasi') }}" role="tab"
                                            aria-controls="diajukan"
                                            aria-selected="{{ Request::routeIs('nofeea.belumvalidasi') ? 'true' : 'false' }}">
                                            Diajukan
                                        </a>
                                    </li>
                                    <li class="nav-item flex-fill" role="presentation">
                                        <a class="nav-link w-50 {{ Request::routeIs('nofeea.ditolak') ? 'active' : '' }}"
                                            id="ditolak-tab" href="{{ route('nofeea.ditolak') }}" role="tab"
                                            aria-controls="ditolak"
                                            aria-selected="{{ Request::routeIs('nofeea.ditolak') ? 'true' : 'false' }}">
                                            Ditolak
                                        </a>
                                    </li>
                                    <li class="nav-item flex-fill" role="presentation">
                                        <a class="nav-link w-50 {{ Request::routeIs('nofeea.diterima') ? 'active' : '' }}"
                                            id="disetujui-tab" href="{{ route('nofeea.diterima') }}" role="tab"
                                            aria-controls="disetujui"
                                            aria-selected="{{ Request::routeIs('nofeea.diterima') ? 'true' : 'false' }}">
                                            Disetujui
                                        </a>
                                    </li>
                                </ul>
