    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Pengajuan Integrasi</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Data <span>| Pengajuan Integrasi</span></h5>
                        &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if ($list->deleted_at)
                                                        <a href="{{ url('/pengajuanintegrasi/restore/' . $list->id) }}"
