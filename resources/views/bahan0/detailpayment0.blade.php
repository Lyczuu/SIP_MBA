...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('index.tablelist0')}}">Table List</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Detail Payment</h5>
                ...
                <form class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-control">
                            ...
                            <input type="checkbox" id="vehicle2" name="vehicle2" value="Car" disabled>
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-control">
                                ...
                                <input class="form-check-input" type="radio" name="gridRadio" id="gridRadios1" value="option1" checked disabled>
                                <label class="form-check-label" for="gridRadios1">
                                  DEVELOPMENT
                                </label>
                                &nbsp;&nbsp;

                                <input class="form-check-input" type="radio" name="gridRadio" id="gridRadios2" value="option2" disabled>
                    ...
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control" id="inputPassword4" value="lorem" disabled>
                    </div>
                    {{-- break --}}
                    <div class="col-4">
...
<br>
                    ...
                    <div class="col-4">
                        <label for="inputPassword4" class="form-label">Alasan Ditolak</label>
